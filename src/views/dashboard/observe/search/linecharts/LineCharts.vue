<template>
    <div>
        ...
        <div class="main">
            <span class="main-title">12354</span>
            <span class="main-content">17.8</span>
            <svg t="1658989978428" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="2332" width="16" height="16">
                <path
                ...
                <path
                    ...
                    fill="#E8D4AB" p-id="2336"></path>
                <path d="M384.1536 444.142933h1.5872l-20.48 409.6h268.2368l-20.48-409.6" fill="#D5382E" p-id="2337">
                </path>
                <path
    ...
    mounted() {
        ...
        lineCharts.setOption({
            ...
            series: [
                {
                    type: "line",
                    data: [10, 20, 15, 11, 14, 8, 6, 10, 20, 22, 26, 28, 22, 18, 28, 30, 32, 36],
                    itemStyle: {
                        opacity: 0,
                    },
                    lineStyle: {
